...
const Observations = ({ navigation }) => {
    ...
    if(!observations?.length) return <EmptyItemsScreen title="addEditObservation.titleEmpty" description="addEditObservation.descriptionEmpty" navigation={navigation}/>;
