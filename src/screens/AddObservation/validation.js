...
const {RINGS, TAG_NUMBER, TAG_TYPE, TYPE_OF_BIRD, BIRD_SEX, BIRD_AGE, BIRD_WAS, BIRD_STATUS, LOCATION_CONDITION, PLACE, COORDINATE_ACCURACY, DATE, DATE_ACCURACY} = FIELD_NAME;
